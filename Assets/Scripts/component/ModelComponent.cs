...
public class ModelComponent : ComponentBase
{
    ...
    public ModelComponent(CharacterObj owner, GameObject modelRoot, int priority = 0) : base(owner, priority, typeof(ModelComponent))
    {
        ModelNum = 0;
        mLoadCount = 0;
    ...
    public ModelComponent(CharacterObj owner, int priority = 0) : base(owner, priority, typeof(ModelComponent))
    {
        ModelNum = 0;
        mLoadCount = 0;
        mLoadCompleted = false;
