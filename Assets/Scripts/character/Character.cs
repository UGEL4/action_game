    ...
    void Start()
    {
        ...
        //actionCtrl.command = inputToCommand;
        {
            ...
            punch01Action.mAutoTerminate = false;
            {
                ...
                punch01Action.mTempBeCanceledTagList = new TempBeCancelledTag[1]
                {
                ...
                punch01Action.attackInfoList = new AttackInfo[1]
                {
                    new AttackInfo
                    {
                        attackPhase = 0,
                ...
                punch01Action.attackPhaseList = new AttackBoxTurnOnInfo[1]
                {
